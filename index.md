...
`Code Review Video: (insert your video link here when it is ready)`
...
Throughout the Computer Science program at Southern New Hampshire University I moved from writing small individual programs to designing and maintaining complete systems. Courses in software engineering, algorithms, databases, and security taught me how to think about structure, performance, and user needs while writing code.

The artifacts on this site show that I can design and build an Android application, implement and analyze algorithms and data structures, and connect an application to a database. The enhancements I completed for CS 499 improved code quality, organization, and security across these projects. Together they demonstrate that I am prepared to contribute to real software development work, continue learning new tools, and follow professional practices such as version control, testing, and documentation.
